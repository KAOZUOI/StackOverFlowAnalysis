...
public class QuestionController {
    ...
    public String getAcceptedAnswerTimeDistribution() throws JsonProcessingException {
        ...
        Line line = new Line()
            ...
            .addXAxis(new CategoryAxis().setBoundaryGap(false)
                .setData(questionResolutionTime.stream().map(entry -> entry.getKey().toString()).toArray(String[]::new)))
            .addYAxis()
            .addSeries(new LineSeries()
                ...
                .setData(questionResolutionTime.stream().map(Map.Entry::getValue).toArray(Number[]::new)));
        Engine engine = new Engine();
        Handlebars handlebars = new Handlebars();
        String html = "";
        try {
    ...
    public String getNonAcceptedAnswerUpvotePercentage() throws JsonProcessingException {
        ...
        Pie pie = new Pie()
            ...
            .setLegend()
            .addSeries(new PieDataItem[] {
                new PieDataItem().setValue(NoAcAnswerUpvoteGreater).setName("No Accepted Answer Upvote Greater"),
                new PieDataItem().setValue(100 - NoAcAnswerUpvoteGreater).setName("Accepted Answer Upvote Greater"),
            });
